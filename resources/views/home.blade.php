            ...
            <div class="grid-3">
                @php
                    $demo = [
                        [
                            'tag' => 'Politics',
                            'title' => 'Key discussion expected in today\'s parliament session',
                            'date' => 'July 07, 2026',
                        ],
                        ['tag' => 'Sports', 'title' => 'Indian team creates new history', 'date' => 'July 06, 2026'],
                        [
                            'tag' => 'Society',
                            'title' => 'New initiative for rural education',
                            'date' => 'July 05, 2026',
                        ],
                    ];
                @endphp
                @foreach ($demo as $i => $item)
                    <article class="news-card reveal delay-{{ $i }}">
                        ...
                        <div class="news-body">
                            ...
                            <h4>{{ $item['title'] }}</h4>
                            <p>A short summary of the story will appear here so readers can grasp the key points instantly.
                            </p>
