...
@section('page-subtitle', 'Update article details')
...
@section('content')
    <style>
        ...
        .image-preview-wrap .placeholder {
            width: 96px;
            height: 96px;
            border-radius: 10px;
            background: #f1f5f9;
            ...
            <form method="POST" action="{{ route('admin.news.update', $news->id) }}" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title"
                        class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $news->title) }}"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text" id="subcategoryHint">Loading subcategories…</div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="short_description" id="short_description"
                        ...
                        placeholder="A one or two line summary shown in listings...">{{ old('short_description', $news->short_description) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror"
                        placeholder="Write the article content...">{{ old('content', $news->content) }}</textarea>
                    <div class="js-error"></div>
                    @error('content')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">JPG, PNG or WEBP. Max 2MB. Leave empty to keep the current image.</div>
                    <div class="js-error"></div>
                    <div class="image-preview-wrap">
                        @if ($news->featured_image)
                            <img id="imagePreview" src="{{ asset('storage/' . $news->featured_image) }}"
                                alt="{{ $news->title }}">
                        @else
                            <img id="imagePreview" alt="Preview" style="display:none;">
                            <div class="placeholder" id="imagePlaceholder">🖼️</div>
                        @endif
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="source" id="source"
                            ...
                            value="{{ old('source', $news->source) }}" placeholder="e.g. PTI, Reuters">
                        @error('source')
                            <div class="error-text">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="location" id="location"
                            ...
                            value="{{ old('location', $news->location) }}" placeholder="e.g. New Delhi">
                        @error('location')
                            <div class="error-text">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tags" id="tags"
                        class="form-control @error('tags') is-invalid @enderror" value="{{ old('tags', $news->tags) }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="meta_title" id="meta_title"
                        ...
                        value="{{ old('meta_title', $news->meta_title) }}" placeholder="SEO title for search engines">
                    @error('meta_title')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="meta_keywords" id="meta_keywords"
                        ...
                        value="{{ old('meta_keywords', $news->meta_keywords) }}" placeholder="Comma separated keywords">
                    @error('meta_keywords')
                        <div class="error-text">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-sm btn-save">💾 Update Article</button>
                </div>
            </form>
        </div>
    </div>
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                ...
                // Pre-load subcategories for the article's current category on page load
                loadSubcategories(
                    '{{ old('category_id', $news->category_id) }}',
                    '{{ old('subcategory_id', $news->subcategory_id) }}'
                );
