...
<head>
    ...
    <style>
        * {
        ...
        .timeline-content .timeline-value {
            font-weight: 500;
            color: #2d3748;
            font-size: 14px;
        }
        ...
        <div class="email-container">
            ...
            <div class="header">
                <div class="header-content">
                    <div class="unblock-icon">🎉</div>
                    <h1>Account Unblocked!</h1>
                    <p class="subtitle">Your account has been restored and is now active</p>
                </div>
            </div>

            <!-- Body -->
            <div class="body-content">
                <h2 class="greeting">Welcome Back, <span>{{ $user->name }}</span> 👋</h2>

                <div class="success-box">
                    <p>✅ <strong>Great News!</strong> We are pleased to inform you that your account has been
                        successfully unblocked by our administrator.</p>
                </div>
                ...
                <div class="welcome-card">
                    ...
                    <div class="welcome-text">
                        <strong>Welcome back!</strong> Your account is now fully restored. You can access all features
                ...
                <div class="features-grid">
                    ...
                    <div class="feature-item">
                        ...
                        <span class="feature-status">✅ Fully Restored</span>
                    </div>
                </div>

                <!-- Timeline -->
                <div class="timeline-box">
                    <div class="timeline-title">⏳ Account Status Timeline</div>

                    <div class="timeline-item">
                        <span class="timeline-icon">⛔</span>
                        <div class="timeline-content">
                            <div class="timeline-label">Previous Status</div>
                            <div class="timeline-value" style="color: #e53e3e;">Blocked</div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <div class="timeline-label">Action Taken</div>
                            <div class="timeline-value" style="color: #3182ce;">Unblocked by {{ $admin->name }}</div>
                        </div>
                    </div>
                ...
                <div class="details-card">
                    ...
                    <div class="detail-row">
                        <span class="detail-label">Unblocked At</span>
                ...
                <p style="color: #4a5568; text-align: center; font-size: 14px; margin-top: 20px;">
                    We're glad to have you back! If you have any questions or need assistance, feel free to reach out.
                </p>
